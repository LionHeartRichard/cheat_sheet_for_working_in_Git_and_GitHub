...
# _____________________________DIFF_______________________________________________________________________
```
git diff
```
...
!examples/**/*.log 
```
# _____________________________________MERGE__&__Delete______________________________________
```
